...
import { ratePost, getAverageRating, getMyRating } from '../services/rating.service';

export default {
  Query: {
    averageRating: async (_: any, args: any) => getAverageRating(Number(args.postId)),
    myRating: async (_: any, args: any, ctx: any) => ctx.userId ? getMyRating(Number(args.postId), ctx.userId) : null,
  },
  Mutation: {
